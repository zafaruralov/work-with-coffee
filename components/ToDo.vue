  ...
  <div class="p-4 flex gap-4 flex-col h-full bg-stone-50">
    ...
    <div class="flex-grow overflow-y-auto gap-4">
          ...
          >
            <div class="flex flex-col justify-center items-start relative w-full">
              <div class="flex w-full items-center">
                ...
                <!-- Task text with in-place editing -->
                <input
                ...
                <span
                  ...
                  @mousedown.stop
                  @dragstart.prevent
                  class="flex-grow cursor-pointer hover:bg-gray-100 px-2 py-1 rounded"
                >
                  {{ task.text }}
                </span>
              </div>
      ...
      <div class="">
        ...
        <div v-if="!sectionsExpanded.inprogress" class="bg-gray-50">
          <div
            class="text-gray-400 text-center italic text-sm py-6 border border-dashed border-gray-300 my-2 mx-2 rounded bg-gray-50"
            @dragover.prevent
      ...
      <div class="">
        ...
        <div v-if="!sectionsExpanded.done" class="bg-gray-50">
          <div
            class="text-gray-400 text-center italic text-sm py-6 border border-dashed border-gray-300 my-2 mx-2 rounded bg-gray-50"
            @dragover.prevent
            ...
            <div class="flex flex-col justify-center items-start relative w-full">
              <div class="flex w-full items-center">
                ...
                <span
                  ...
                  @mousedown.stop
                  @dragstart.prevent
                  class="flex-grow cursor-pointer hover:bg-gray-100 px-2 py-1 rounded line-through text-gray-500"
                >
                  {{ task.text }}
                </span>
              </div>
